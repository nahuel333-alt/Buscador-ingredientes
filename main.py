...
# ================= Pantallas de resultados y elección se mantienen igual =================
# Para no hacer este mensaje kilométrico, las demás clases (ElegirIngredienteScreen, ElegirEfectoScreen,
# ResultadoIngredienteScreen, ResultadoEfectoScreen) pueden copiarse tal cual tu versión original
# solo asegurándose de usar `self.app` en lugar de `App.get_running_app()`.
# Esto evita errores de inicialización en Android y problemas con user_data_dir.
